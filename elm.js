...
var author$project$Main$Model = function (currentTime) {
	return function (l1) {
		return function (l2) {
			return function (r1) {
				return function (r2) {
					return function (omega1) {
						return function (omega2) {
							return function (alpha) {
								return function (beta) {
									return function (circleDistance) {
										return function (t) {
											return {alpha: alpha, beta: beta, circleDistance: circleDistance, currentTime: currentTime, l1: l1, l2: l2, omega1: omega1, omega2: omega2, r1: r1, r2: r2, t: t};
										};
									};
								};
							};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$Model(
			elm$time$Time$millisToPosix(0))(2.5)(2.5)(1.0)(1.0)(1.0)(2.01)(0.0)(0.0)(3.0)(0.0),
		elm$core$Platform$Cmd$none);
};
var author$project$Main$Tick = function (a) {
	return {$: 'Tick', a: a};
};
var author$project$Main$tickrate = 30;
...
var author$project$Main$subscriptions = function (model) {
	return A2(elm$time$Time$every, author$project$Main$tickrate, author$project$Main$Tick);
};
var author$project$Main$shift = F2(
	function (secondsPassed, model) {
		return _Utils_update(
			model,
			{alpha: model.alpha + (model.omega1 * secondsPassed), beta: model.beta + (model.omega2 * secondsPassed), t: model.t + secondsPassed});
	});
var author$project$Main$step = function (i) {
	var secondsPassed = (1.0e-3 * author$project$Main$tickrate) * i;
	return author$project$Main$shift(secondsPassed);
};
...
var author$project$Main$updateParameter = F3(
	function (param, str, model) {
		switch (param.$) {
			case 'L1':
				return _Utils_update(
					model,
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'Tick') {
			var time = msg.a;
			var next = A2(author$project$Main$step, 1, model);
			return _Utils_Tuple2(
				_Utils_update(
					next,
					{currentTime: time}),
			...
			var str = msg.b;
			return _Utils_Tuple2(
				A3(author$project$Main$updateParameter, p, str, model),
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Main$Distance = {$: 'Distance'};
var author$project$Main$L1 = {$: 'L1'};
var author$project$Main$L2 = {$: 'L2'};
var author$project$Main$Omega1 = {$: 'Omega1'};
var author$project$Main$Omega2 = {$: 'Omega2'};
var author$project$Main$R1 = {$: 'R1'};
var author$project$Main$R2 = {$: 'R2'};
...
var terezka$elm_charts$Plot$Linear = F2(
	function (a, b) {
		return {$: 'Linear', a: a, b: b};
	});
var terezka$elm_charts$Plot$Monotone = F2(
	function (a, b) {
		return {$: 'Monotone', a: a, b: b};
	});
var author$project$Main$colorSeries = F2(
	function (color, series) {
		var _n0 = series.interpolation;
		switch (_n0.$) {
			case 'None':
				return series;
			case 'Linear':
				...
				return _Utils_update(
					...
					{
						interpolation: A2(
							terezka$elm_charts$Plot$Linear,
							fill,
							_List_fromArray(
								[
			...
			default:
				...
				return _Utils_update(
					...
					{
						interpolation: A2(
							terezka$elm_charts$Plot$Monotone,
							fill,
							_List_fromArray(
								[
									elm$svg$Svg$Attributes$stroke(color)
...
var author$project$Main$p1 = function (m) {
	return (m.r1 * elm$core$Basics$sin(m.alpha)) - (0.5 * m.circleDistance);
};
var elm$core$Basics$cos = _Basics_cos;
var author$project$Main$q1 = function (m) {
	return m.r1 * elm$core$Basics$cos(m.alpha);
};
var author$project$Main$numPoints = 500;
var elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var elm$svg$Svg$text = elm$virtual_dom$VirtualDom$text;
var terezka$elm_charts$Plot$dot = F3(
	function (view, x, y) {
		return {
			hint: elm$core$Maybe$Nothing,
			view: elm$core$Maybe$Just(view),
			x: x,
			xLine: elm$core$Maybe$Nothing,
			xTick: elm$core$Maybe$Nothing,
			y: y,
			yLine: elm$core$Maybe$Nothing,
			yTick: elm$core$Maybe$Nothing
		};
	});
var terezka$elm_charts$Plot$clear = terezka$elm_charts$Plot$dot(
	elm$svg$Svg$text(''));
var author$project$Main$timeSeriesPlot = F3(
	function (maxTime, _n0, model) {
		var x_ = _n0.a;
		var y_ = _n0.b;
		var timesteps = A2(
			elm$core$List$map,
			function (i) {
				return (maxTime * i) / author$project$Main$numPoints;
			},
			A2(elm$core$List$range, 0, author$project$Main$numPoints));
		var models = A2(elm$core$List$map, author$project$Main$shift, timesteps);
		return A2(
			elm$core$List$map,
			function (m) {
				return A2(
					terezka$elm_charts$Plot$clear,
					x_(m),
					y_(m));
			},
			A2(
...
var author$project$Main$leftCircleCurveData = function (model) {
	var maxTime = (2.0 * elm$core$Basics$pi) / model.omega1;
	return A3(
		author$project$Main$timeSeriesPlot,
		maxTime,
		_Utils_Tuple2(author$project$Main$p1, author$project$Main$q1),
		model);
};
...
var terezka$elm_charts$Plot$viewCircle = F2(
...
var author$project$Main$timePointPlot = F3(
	function (color, x_, y_) {
		return _List_fromArray(
			[
				A3(
				terezka$elm_charts$Plot$dot,
				A2(terezka$elm_charts$Plot$viewCircle, 5.0, color),
				x_,
				y_)
			]);
	});
var author$project$Main$leftCirclePointData = F2(
	function (color, model) {
		return A3(
			author$project$Main$timePointPlot,
			color,
			author$project$Main$p1(model),
			author$project$Main$q1(model));
	});
var author$project$Main$previewTime = 20.0;
var author$project$Main$p2 = function (m) {
	return (0.5 * m.circleDistance) + (m.r2 * elm$core$Basics$sin(m.beta));
};
var author$project$Main$q2 = function (m) {
	return m.r2 * elm$core$Basics$cos(m.beta);
};
var author$project$Main$square = function (x_) {
	return x_ * x_;
};
var author$project$Main$l3squared = function (m) {
	return author$project$Main$square(
		author$project$Main$p2(m) - author$project$Main$p1(m)) + author$project$Main$square(
		author$project$Main$q2(m) - author$project$Main$q1(m));
};
var elm$core$Basics$sqrt = _Basics_sqrt;
var author$project$Main$l3 = A2(elm$core$Basics$composeL, elm$core$Basics$sqrt, author$project$Main$l3squared);
var author$project$Main$cosTheta = function (m) {
	return ((author$project$Main$square(m.l1) + author$project$Main$l3squared(m)) - author$project$Main$square(m.l2)) / ((2 * m.l1) * author$project$Main$l3(m));
};
var author$project$Main$rho = function (m) {
	return m.l1 * author$project$Main$cosTheta(m);
};
var author$project$Main$h = function (m) {
	return elm$core$Basics$sqrt(
		author$project$Main$square(m.l1) - author$project$Main$square(
			author$project$Main$rho(m)));
};
var author$project$Main$x = function (m) {
	return (author$project$Main$p1(m) + (((m.l1 / author$project$Main$l3(m)) * (author$project$Main$p2(m) - author$project$Main$p1(m))) * author$project$Main$cosTheta(m))) - ((author$project$Main$h(m) / author$project$Main$l3(m)) * (author$project$Main$q2(m) - author$project$Main$q1(m)));
};
var author$project$Main$y = function (m) {
	return (author$project$Main$q1(m) + (((m.l1 / author$project$Main$l3(m)) * (author$project$Main$q2(m) - author$project$Main$q1(m))) * author$project$Main$cosTheta(m))) + ((author$project$Main$h(m) / author$project$Main$l3(m)) * (author$project$Main$p2(m) - author$project$Main$p1(m)));
};
var elm$core$Basics$negate = function (n) {
	return -n;
};
var author$project$Main$missajouCurveData = function (model) {
	var offset = (-0.5) * author$project$Main$previewTime;
	var offsetModel = _Utils_update(
		model,
		{t: model.t + offset});
	return A3(
		author$project$Main$timeSeriesPlot,
		author$project$Main$previewTime,
		_Utils_Tuple2(author$project$Main$x, author$project$Main$y),
		offsetModel);
};
var author$project$Main$missajouPointData = F2(
	function (color, model) {
		return A3(
			author$project$Main$timePointPlot,
			color,
			author$project$Main$x(model),
			author$project$Main$y(model));
	});
var author$project$Main$rightCircleCurveData = function (model) {
	var maxTime = (2 * elm$core$Basics$pi) / model.omega2;
	return A3(
		author$project$Main$timeSeriesPlot,
		maxTime,
		_Utils_Tuple2(author$project$Main$p2, author$project$Main$q2),
		model);
};
var author$project$Main$rightCirclePointData = F2(
	function (color, model) {
		return A3(
			author$project$Main$timePointPlot,
			color,
			author$project$Main$p2(model),
			author$project$Main$q2(model));
	});
...
var terezka$elm_charts$Internal$Colors$pinkStroke = '#ff9edf';
var terezka$elm_charts$Plot$line = function (toDataPoints) {
	return {
		...
		interpolation: A2(
			...
			_List_fromArray(
				[
					elm$svg$Svg$Attributes$stroke(terezka$elm_charts$Internal$Colors$pinkStroke)
				])),
...
var terezka$elm_charts$Plot$addNiceReachForArea = F2(
...
var terezka$elm_charts$Plot$addNiceReachForSeries = function (series) {
	var _n0 = series.interpolation;
	switch (_n0.$) {
		case 'None':
		...
		case 'Linear':
			var fill = _n0.a;
			return terezka$elm_charts$Plot$addNiceReachForArea(fill);
		default:
			var fill = _n0.a;
			return terezka$elm_charts$Plot$addNiceReachForArea(fill);
	}
...
var terezka$elm_charts$Plot$viewDataPoint = F2(
	function (plotSummary, _n0) {
		var x = _n0.x;
		var y = _n0.y;
		var view = _n0.view;
		if (view.$ === 'Nothing') {
...
var terezka$elm_charts$Plot$viewDataPoints = F2(
	function (plotSummary, dataPoints) {
		return A2(
			...
			A2(
				...
				A2(
					elm$core$List$map,
					terezka$elm_charts$Plot$viewDataPoint(plotSummary),
					dataPoints)));
	});
...
var terezka$elm_charts$Internal$Draw$yClosestToZero = function (_n0) {
	var y = _n0.y;
	return A3(elm$core$Basics$clamp, y.min, y.max, 0);
};
var terezka$elm_charts$Internal$Draw$areaBegin = F2(
	function (plot, points) {
		if (points.b) {
			var x = points.a.x;
			var y = points.a.y;
			...
			return _List_fromArray(
				[
					...
					terezka$elm_charts$Internal$Draw$Move,
					x,
					terezka$elm_charts$Internal$Draw$yClosestToZero(plot)),
					A2(terezka$elm_charts$Internal$Draw$Line, x, y)
				]);
		} else {
			return _List_Nil;
		}
	});
var terezka$elm_charts$Internal$Draw$areaEnd = F2(
	function (plot, points) {
...
var terezka$elm_charts$Internal$Draw$linearArea = F2(
	function (plot, points) {
		return A2(
			elm$core$List$map,
			terezka$elm_charts$Internal$Draw$translateCommand(plot),
			_Utils_ap(
				A2(terezka$elm_charts$Internal$Draw$areaBegin, plot, points),
				_Utils_ap(
					A2(elm$core$List$map, terezka$elm_charts$Internal$Draw$lineCommand, points),
					A2(terezka$elm_charts$Internal$Draw$areaEnd, plot, points))));
	});
var terezka$elm_charts$Internal$Draw$monotoneXCurve = F4(
	function (point0, point1, tangent0, tangent1) {
		var dx = (point1.x - point0.x) / 3;
		return _List_fromArray(
			[
				A6(terezka$elm_charts$Internal$Draw$CubicBeziers, point0.x + dx, point0.y + (dx * tangent0), point1.x - dx, point1.y - (dx * tangent1), point1.x, point1.y)
			]);
	});
var terezka$elm_charts$Internal$Draw$sign = function (x) {
	return (x < 0) ? (-1) : 1;
};
var terezka$elm_charts$Internal$Draw$toH = F2(
	function (h0, h1) {
		return (!h0) ? ((h1 < 0) ? (0 * (-1)) : h1) : h0;
	});
var terezka$elm_charts$Internal$Draw$slope3 = F3(
	function (point0, point1, point2) {
		var h1 = point2.x - point1.x;
		var h0 = point1.x - point0.x;
		var s0h = A2(terezka$elm_charts$Internal$Draw$toH, h0, h1);
		var s0 = (point1.y - point0.y) / s0h;
		var s1h = A2(terezka$elm_charts$Internal$Draw$toH, h1, h0);
		var s1 = (point2.y - point1.y) / s1h;
		var p = ((s0 * h1) + (s1 * h0)) / (h0 + h1);
		var slope = (terezka$elm_charts$Internal$Draw$sign(s0) + terezka$elm_charts$Internal$Draw$sign(s1)) * A2(
			elm$core$Basics$min,
			A2(
				elm$core$Basics$min,
...
var terezka$elm_charts$Internal$Draw$monotoneXNext = F3(
		...
		while (true) {
			if (points.b && points.b.b) {
				if (points.b.b.b) {
					...
					var p2 = _n2.a;
					var rest = _n2.b;
					var tangent1 = A3(terezka$elm_charts$Internal$Draw$slope3, p0, p1, p2);
					var nextCommands = _Utils_ap(
						commands,
						A4(terezka$elm_charts$Internal$Draw$monotoneXCurve, p0, p1, tangent0, tangent1));
					var $temp$points = A2(
						elm$core$List$cons,
						p1,
					...
					var _n3 = points.b;
					var p2 = _n3.a;
					var tangent1 = A3(terezka$elm_charts$Internal$Draw$slope3, p1, p2, p2);
					return _Utils_ap(
						commands,
						A4(terezka$elm_charts$Internal$Draw$monotoneXCurve, p1, p2, tangent0, tangent1));
				}
			} else {
				return commands;
			}
...
var terezka$elm_charts$Internal$Draw$slope2 = F3(
	function (point0, point1, t) {
		var h = point1.x - point0.x;
		return h ? ((((3 * (point1.y - point0.y)) / h) - t) / 2) : t;
	});
var terezka$elm_charts$Internal$Draw$monotoneXBegin = function (points) {
	if ((points.b && points.b.b) && points.b.b.b) {
		...
		var rest = _n2.b;
		var tangent1 = A3(terezka$elm_charts$Internal$Draw$slope3, p0, p1, p2);
		var tangent0 = A3(terezka$elm_charts$Internal$Draw$slope2, p0, p1, tangent1);
		return _Utils_ap(
			A4(terezka$elm_charts$Internal$Draw$monotoneXCurve, p0, p1, tangent0, tangent1),
			A3(
				terezka$elm_charts$Internal$Draw$monotoneXNext,
				A2(
					elm$core$List$cons,
					p1,
					A2(elm$core$List$cons, p2, rest)),
...
var terezka$elm_charts$Internal$Draw$monotoneX = F2(
	function (plot, points) {
		return A2(
			elm$core$List$map,
			terezka$elm_charts$Internal$Draw$translateCommand(plot),
			_Utils_ap(
				A2(terezka$elm_charts$Internal$Draw$lineBegin, plot, points),
				terezka$elm_charts$Internal$Draw$monotoneXBegin(points)));
	});
var terezka$elm_charts$Internal$Draw$monotoneXArea = F2(
	function (plot, points) {
		return A2(
			elm$core$List$map,
			terezka$elm_charts$Internal$Draw$translateCommand(plot),
...
var terezka$elm_charts$Internal$Colors$transparent = 'transparent';
...
var terezka$elm_charts$Plot$point = function (_n0) {
	var x = _n0.x;
	var y = _n0.y;
	return A2(terezka$elm_charts$Internal$Draw$Point, x, y);
};
var terezka$elm_charts$Plot$points = elm$core$List$map(terezka$elm_charts$Plot$point);
var terezka$elm_charts$Plot$viewInterpolation = F7(
	function (customizations, summary, toLine, toArea, area_, attributes, dataPoints) {
		if (area_.$ === 'Nothing') {
			return A2(
				...
				A2(
					elm$core$List$cons,
					elm$svg$Svg$Attributes$fill(terezka$elm_charts$Internal$Colors$transparent),
					A2(
						elm$core$List$cons,
						elm$svg$Svg$Attributes$stroke(terezka$elm_charts$Internal$Colors$pinkStroke),
						A2(
							...
							A2(
								...
								elm$svg$Svg$Attributes$clipPath(
									'url(#' + (terezka$elm_charts$Plot$toClipPathId(customizations) + ')')),
								attributes)))),
				A2(
					toLine,
					summary,
					terezka$elm_charts$Plot$points(dataPoints)));
		} else {
			var color = area_.a;
			return A2(
				terezka$elm_charts$Internal$Draw$draw,
...
var terezka$elm_charts$Plot$viewPath = F4(
	function (customizations, plotSummary, interpolation, dataPoints) {
		switch (interpolation.$) {
			...
			case 'Linear':
				...
				return A7(terezka$elm_charts$Plot$viewInterpolation, customizations, plotSummary, terezka$elm_charts$Internal$Draw$linear, terezka$elm_charts$Internal$Draw$linearArea, fill, attributes, dataPoints);
			default:
				var fill = interpolation.a;
				var attributes = interpolation.b;
				return A7(terezka$elm_charts$Plot$viewInterpolation, customizations, plotSummary, terezka$elm_charts$Internal$Draw$monotoneX, terezka$elm_charts$Internal$Draw$monotoneXArea, fill, attributes, dataPoints);
		}
	});
var terezka$elm_charts$Plot$viewASeries = F4(
	function (customizations, plotSummary, _n0, dataPoints) {
		var axis = _n0.axis;
		var interpolation = _n0.interpolation;
		return A2(
			elm$svg$Svg$g,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					A4(terezka$elm_charts$Plot$viewPath, customizations, plotSummary, interpolation, dataPoints)),
					A2(terezka$elm_charts$Plot$viewDataPoints, plotSummary, dataPoints)
				]));
	});
var terezka$elm_charts$Plot$viewActualJunk = F2(
...
var terezka$elm_charts$Plot$viewSeriesCustom = F3(
	function (customizations, series, data) {
		var dataPoints = A2(
			elm$core$List$map,
			function (_n1) {
				var toDataPoints = _n1.toDataPoints;
				return toDataPoints(data);
			},
			series);
		var allDataPoints = elm$core$List$concat(dataPoints);
		var addNiceReach = function (summary_) {
			return A3(elm$core$List$foldl, terezka$elm_charts$Plot$addNiceReachForSeries, summary_, series);
		};
		var summary = A3(terezka$elm_charts$Plot$toPlotSummary, customizations, addNiceReach, allDataPoints);
		var viewActualSeries = elm$core$Maybe$Just(
			A2(
				...
				A3(
					elm$core$List$map2,
					A2(terezka$elm_charts$Plot$viewASeries, customizations, summary),
					series,
					dataPoints)));
		...
		var viewHint = function () {
			...
			if (!_n0.b) {
				...
				return A2(
					elm$html$Html$map,
					elm$core$Basics$never,
					A2(customizations.hintContainer, summary, views));
			}
		}();
		var viewHorizontalAxes = A4(
			terezka$elm_charts$Plot$viewHorizontalAxis,
			summary,
		...
		var viewJunks = elm$core$Maybe$Just(
			A2(
				...
				A2(
					elm$core$List$map,
					terezka$elm_charts$Plot$viewActualJunk(summary),
				...
				A2(
					...
					A3(
						...
						A2(
							...
							terezka$elm_charts$Plot$viewVerticalAxis(summary)),
						series,
						A2(
							elm$core$List$map,
							elm$core$List$filterMap(
...
var author$project$Main$viewPlot = function (model) {
	var maxDist = 0.5 * (((model.r1 + model.l1) + model.r2) + model.l2);
	var _default = terezka$elm_charts$Plot$defaultSeriesPlotCustomizations;
	var plotSettings = _Utils_update(
		_default,
		{
			height: 400,
			toDomainHighest: function (i) {
				return 1.4 * A2(elm$core$Basics$max, 5, maxDist);
			},
			toDomainLowest: function (i) {
				return A2(elm$core$Basics$min, -model.r1, -model.r2);
			},
			toRangeHighest: function (i) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('plot')
			]),
		_List_fromArray(
			[
				A3(
				terezka$elm_charts$Plot$viewSeriesCustom,
				plotSettings,
				_List_fromArray(
					[
						A2(
						...
						terezka$elm_charts$Plot$line(
							function (m) {
								return _Utils_ap(
									A2(author$project$Main$missajouPointData, 'lightblue', m),
									A2(author$project$Main$rightCirclePointData, 'black', m));
							})),
						A2(
						author$project$Main$colorSeries,
						'green',
						terezka$elm_charts$Plot$line(
							function (m) {
								return _Utils_ap(
									A2(author$project$Main$missajouPointData, 'lightblue', m),
									A2(author$project$Main$leftCirclePointData, 'black', m));
							})),
						A2(
						author$project$Main$colorSeries,
						'black',
						terezka$elm_charts$Plot$line(author$project$Main$rightCircleCurveData)),
						A2(
						author$project$Main$colorSeries,
						'black',
						terezka$elm_charts$Plot$line(author$project$Main$leftCircleCurveData)),
						A2(
						author$project$Main$colorSeries,
						'pink',
						terezka$elm_charts$Plot$line(author$project$Main$missajouCurveData))
					]),
				model)
			]));
};
var author$project$Main$extract = function (param) {
	switch (param.$) {
		case 'L1':
			return function ($) {
				return $.l1;
...
var author$project$Main$nameOf = function (p) {
	switch (p.$) {
		case 'L1':
			return 'L1';
		case 'L2':
	...
	function (param, model) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					author$project$Main$nameOf(param) + (': ' + A2(
						myrho$elm_round$Round$round,
						2,
						A2(author$project$Main$extract, param, model))))
				]));
	});
var author$project$Main$Update = F2(
	function (a, b) {
...
var author$project$Main$dmax = function (m) {
	return ((m.l1 + m.l2) - m.r1) - m.r2;
};
var author$project$Main$l1max = function (m) {
	return ((m.l2 + m.circleDistance) - m.r1) - m.r2;
};
var author$project$Main$l2max = function (m) {
	return ((m.l1 + m.circleDistance) - m.r1) - m.r2;
};
var author$project$Main$omegaMax = 5.0;
var author$project$Main$r1max = function (m) {
	return A2(
		elm$core$Basics$min,
		(m.l1 - m.r2) - elm$core$Basics$abs(m.circleDistance - m.l2),
		((m.circleDistance + m.l2) - m.l1) - m.r2);
};
var author$project$Main$r2max = function (m) {
	return A2(
		elm$core$Basics$min,
		(m.l1 - m.r1) - elm$core$Basics$abs(m.circleDistance - m.l2),
		((m.circleDistance + m.l2) - m.l1) - m.r1);
};
var author$project$Main$maxOf = function (param) {
	switch (param.$) {
		case 'L1':
			return author$project$Main$l1max;
		case 'L2':
			return author$project$Main$l2max;
		case 'R1':
			return author$project$Main$r1max;
		case 'R2':
			return author$project$Main$r2max;
		case 'Omega1':
			return function (i) {
				return author$project$Main$omegaMax;
			};
		case 'Omega2':
			return function (i) {
				return author$project$Main$omegaMax;
		...
		default:
			return author$project$Main$dmax;
	}
};
var author$project$Main$dmin = function (m) {
	return (elm$core$Basics$abs(m.l1 - m.l2) + m.r1) + m.r2;
};
var author$project$Main$l1min = function (m) {
	return elm$core$Basics$abs(m.l2 - m.circleDistance) + (m.r1 + m.r2);
};
var author$project$Main$l2min = function (m) {
	return elm$core$Basics$abs(m.l1 - m.circleDistance) + (m.r1 + m.r2);
};
var author$project$Main$minOf = function (param) {
	switch (param.$) {
		case 'L1':
			return author$project$Main$l1min;
		case 'L2':
			return author$project$Main$l2min;
		case 'R1':
			return function (i) {
				return 0;
			};
		...
		default:
			return author$project$Main$dmin;
	}
};
					...
					_List_fromArray(
						[
							...
							A2(
								myrho$elm_round$Round$round,
								2,
								A2(author$project$Main$minOf, param, model)))
						])),
					A2(
					elm$html$Html$input,
					_List_fromArray(
						[
							...
							elm$core$String$fromFloat(
								A2(author$project$Main$maxOf, param, model))),
							...
							author$project$Main$Update(param))
						]),
					_List_Nil),
					A2(
					elm$html$Html$label,
...
var author$project$Main$viewSliderWithLabel = F2(
	function (p, m) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('slider-with-label'),
					elm$html$Html$Attributes$class('col'),
					elm$html$Html$Attributes$class('form-group')
				]),
			_List_fromArray(
				[
					A2(author$project$Main$viewLabel, p, m),
					A2(author$project$Main$viewSlider, p, m)
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(author$project$Main$viewSliderWithLabel, author$project$Main$L1, model),
						A2(author$project$Main$viewSliderWithLabel, author$project$Main$L2, model),
						A2(author$project$Main$viewSliderWithLabel, author$project$Main$R1, model),
						A2(author$project$Main$viewSliderWithLabel, author$project$Main$R2, model),
						A2(author$project$Main$viewSliderWithLabel, author$project$Main$Omega1, model),
						A2(author$project$Main$viewSliderWithLabel, author$project$Main$Omega2, model),
						A2(author$project$Main$viewSliderWithLabel, author$project$Main$Distance, model)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						author$project$Main$viewPlot(model)
					]))
			]));
};
